...
@pytest.fixture
def calculator():
    obj = MeanCalculator.__new__(MeanCalculator)
...
def test_execute_returns_self():
    calculator = MeanCalculator.__new__(MeanCalculator)
...
# NOTE - These block code for integration test the MeanCalculator
