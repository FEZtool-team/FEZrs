...
@pytest.fixture
def calculator():
    obj = MedianCalculator.__new__(MedianCalculator)
...
def test_process_reduces_impulse_noise(calculator):
    result = calculator.process()
...
def test_execute_returns_self():
    calculator = MedianCalculator.__new__(MedianCalculator)
...
# NOTE - These block code for integration test the MedianCalculator
